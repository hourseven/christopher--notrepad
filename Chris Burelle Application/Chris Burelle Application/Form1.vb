Public Class Form1
    ...
    Private Sub NewToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles NewToolStripMenuItem.Click
        ...
        If TextBox1.Modified Then
            'If the text of notepad changed, the program will ask the user if they want to save the chamges
            ...
            ElseIf ask = MsgBoxResult.Yes Then
                ...
                TextBox1.Clear()
            End If
            'If texbox's text is still the same, notepad will open a new page:
        Else
            TextBox1.Clear()
        End If
    End Sub
    ...
    Private Sub AboutToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AboutToolStripMenuItem.Click
        MsgBox("Created By Christopher Keith Burelle Jr. on May 5th, 2018")
    End Sub
End Class
